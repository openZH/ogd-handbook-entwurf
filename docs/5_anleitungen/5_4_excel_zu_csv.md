...
Für die Publikation als OGD müssen Excel-Dateien als CSV exportiert werden. Die Anforderungen an das Format sind in den [Dateiformatvorgaben](/ogd-handbook-entwurf/daten_struktur_format/dateiformate) beschrieben.
